-- Excel Course - Complete Lesson Structure (Ordered) - Safe to Run Multiple Times
-- Uses INSERT IGNORE to prevent duplicates

-- Get the course ID (creates course if it doesn't exist)
...
SET @module_id = (SELECT id FROM modules WHERE course_id = @excel_course_id AND title = 'Getting Started with Excel' ORDER BY id LIMIT 1);
...
INSERT IGNORE INTO quizzes (module_id, title, description, time_limit, passing_score, published)
SELECT @module_id, 'Module 1 Quiz', 'Test your knowledge of Excel basics', 10, 70.00, 1
WHERE NOT EXISTS (SELECT 1 FROM quizzes WHERE module_id = @module_id AND title = 'Module 1 Quiz');
...
SET @module_id = (SELECT id FROM modules WHERE course_id = @excel_course_id AND title = 'Working with Data' ORDER BY id LIMIT 1);
...
(@module_id, 'Mini Project: Monthly Expense Tracker', 'mini-project-monthly-expense-tracker', 'Create a monthly expense tracker with all the skills you learned in this module.', 'Create a monthly expense tracker with all the skills you learned in this module.', 'https://youtube.com/watch?v=example14', 2700, 10, 0, 1);

INSERT IGNORE INTO quizzes (module_id, title, description, time_limit, passing_score, published)
SELECT @module_id, 'Module 2 Quiz', 'Test your data handling skills', 10, 70.00, 1
WHERE NOT EXISTS (SELECT 1 FROM quizzes WHERE module_id = @module_id AND title = 'Module 2 Quiz');
...
SET @module_id = (SELECT id FROM modules WHERE course_id = @excel_course_id AND title = 'Basic Formulas' ORDER BY id LIMIT 1);
...
INSERT IGNORE INTO quizzes (module_id, title, description, time_limit, passing_score, published)
SELECT @module_id, 'Module 3 Quiz', 'Test your formula skills', 10, 70.00, 1
WHERE NOT EXISTS (SELECT 1 FROM quizzes WHERE module_id = @module_id AND title = 'Module 3 Quiz');
...
SET @module_id = (SELECT id FROM modules WHERE course_id = @excel_course_id AND title = 'Essential Functions' ORDER BY id LIMIT 1);
...
(@module_id, 'Mini Project: Student Grade Calculator', 'mini-project-student-grade-calculator', 'Build a student grade calculator using functions.', 'Build a student grade calculator using functions.', 'https://youtube.com/watch?v=example28', 2700, 8, 0, 1);

INSERT IGNORE INTO quizzes (module_id, title, description, time_limit, passing_score, published)
SELECT @module_id, 'Module 4 Quiz', 'Test your function knowledge', 10, 70.00, 1
WHERE NOT EXISTS (SELECT 1 FROM quizzes WHERE module_id = @module_id AND title = 'Module 4 Quiz');
...
SET @module_id = (SELECT id FROM modules WHERE course_id = @excel_course_id AND title = 'Working with Text & Dates' ORDER BY id LIMIT 1);
...
INSERT IGNORE INTO quizzes (module_id, title, description, time_limit, passing_score, published)
SELECT @module_id, 'Module 5 Quiz', 'Test text and date functions', 10, 70.00, 1
WHERE NOT EXISTS (SELECT 1 FROM quizzes WHERE module_id = @module_id AND title = 'Module 5 Quiz');
...
SET @module_id = (SELECT id FROM modules WHERE course_id = @excel_course_id AND title = 'Lookup & Reference Functions' ORDER BY id LIMIT 1);
...
(@module_id, 'Mini Project: Sales Report with Lookup Table', 'mini-project-sales-report-lookup', 'Create a sales report using lookup functions.', 'Create a sales report using lookup functions.', 'https://youtube.com/watch?v=example42', 2700, 8, 0, 1);

INSERT IGNORE INTO quizzes (module_id, title, description, time_limit, passing_score, published)
SELECT @module_id, 'Module 6 Quiz', 'Test lookup functions', 10, 70.00, 1
WHERE NOT EXISTS (SELECT 1 FROM quizzes WHERE module_id = @module_id AND title = 'Module 6 Quiz');
...
SET @module_id = (SELECT id FROM modules WHERE course_id = @excel_course_id AND title = 'Conditional Tools' ORDER BY id LIMIT 1);
...
INSERT IGNORE INTO quizzes (module_id, title, description, time_limit, passing_score, published)
SELECT @module_id, 'Module 7 Quiz', 'Test conditional tools', 10, 70.00, 1
WHERE NOT EXISTS (SELECT 1 FROM quizzes WHERE module_id = @module_id AND title = 'Module 7 Quiz');
...
SET @module_id = (SELECT id FROM modules WHERE course_id = @excel_course_id AND title = 'Pivot Tables' ORDER BY id LIMIT 1);
...
(@module_id, 'Mini Project: Business Sales Dashboard', 'mini-project-business-sales-dashboard', 'Build a business sales dashboard with Pivot Tables.', 'Build a business sales dashboard with Pivot Tables.', 'https://youtube.com/watch?v=example54', 3600, 8, 0, 1);

INSERT IGNORE INTO quizzes (module_id, title, description, time_limit, passing_score, published)
SELECT @module_id, 'Module 8 Quiz', 'Test Pivot Table skills', 10, 70.00, 1
WHERE NOT EXISTS (SELECT 1 FROM quizzes WHERE module_id = @module_id AND title = 'Module 8 Quiz');
...
SET @module_id = (SELECT id FROM modules WHERE course_id = @excel_course_id AND title = 'Advanced Functions' ORDER BY id LIMIT 1);
...
INSERT IGNORE INTO quizzes (module_id, title, description, time_limit, passing_score, published)
SELECT @module_id, 'Module 9 Quiz', 'Test advanced functions', 10, 70.00, 1
WHERE NOT EXISTS (SELECT 1 FROM quizzes WHERE module_id = @module_id AND title = 'Module 9 Quiz');
...
SET @module_id = (SELECT id FROM modules WHERE course_id = @excel_course_id AND title = 'Data Cleaning & Transformation' ORDER BY id LIMIT 1);
...
INSERT IGNORE INTO quizzes (module_id, title, description, time_limit, passing_score, published)
SELECT @module_id, 'Module 10 Quiz', 'Test data cleaning skills', 10, 70.00, 1
WHERE NOT EXISTS (SELECT 1 FROM quizzes WHERE module_id = @module_id AND title = 'Module 10 Quiz');
...
SET @module_id = (SELECT id FROM modules WHERE course_id = @excel_course_id AND title = 'Dashboards & Reporting' ORDER BY id LIMIT 1);
...
(@module_id, 'Dashboard Layout Principles', 'dashboard-layout-principles', 'Learn effective dashboard layouts.', 'Learn effective dashboard layouts.', 'https://youtube.com/watch_v=example68', 900, 4, 0, 1),
...
SET @module_id = (SELECT id FROM modules WHERE course_id = @excel_course_id AND title = 'Real-World Applications' ORDER BY id LIMIT 1);
...
INSERT IGNORE INTO quizzes (module_id, title, description, time_limit, passing_score, is_final, published)
SELECT @module_id, 'Final Assessment', 'Comprehensive Excel exam', 60, 80.00, 1, 1
WHERE NOT EXISTS (SELECT 1 FROM quizzes WHERE module_id = @module_id AND is_final = 1);
...
SELECT 'Excel course setup complete!' AS result;
